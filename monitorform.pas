...
uses
  ...
  ButtonPanel, Grids, Menus, sqldb, strconsts, DxCtrls, dbengine;
...
uses
  dxusers, DateUtils, apputils, formmanager, helpform;
...
begin
  ...
  try
    ...
    begin
      ...
      if Fm <> nil then
        RGrid.Cells[2, r] := Fm.FormCaption;
...
begin
  ...
  FMon.Remote:=DBase.Remote;
  FMon.UserName:=DBase.UserName;
  FMon.Pwd:=DBase.Pwd;
