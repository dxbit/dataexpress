...
uses
  Classes, SysUtils, StdCtrls, Graphics, ExtCtrls, Buttons, LResources,
  Controls, LMessages;
...
procedure Register;
begin
  RegisterComponents('dxComponents', [{TFontSampler, }TColorSampler]);
end;
...
begin
  ...
  FButton.LoadGlyphFromLazarusResource('delete16');
  FButton.Flat := True;
