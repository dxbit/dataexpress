...
type
  ...
  TComputeArrowHeadProc = function(const APosition: TBGRAPointF; const ADirection: TBGRAPointF; const AWidth: single; const ACurrentPos: single): ArrayOfTPointF of object;
...
procedure BGRAPolyLine(bmp: TBGRACustomBitmap; const linepts: array of TBGRAPointF;
...
function ComputeWidePolylinePoints(const linepts: array of TBGRAPointF; width: single;
...
function ComputeWidePolyPolylinePoints(const linepts: array of TBGRAPointF; width: single;
          pencolor: TBGRAPixel; linecap: TPenEndCap; joinstyle: TPenJoinStyle; const penstyle: TBGRAPenStyle;
...
procedure ApplyPenStyle(const leftPts, rightPts: array of TBGRAPointF; const penstyle: TBGRAPenStyle;
...
var
  ...
  dashLeftStartPos,dashRightStartPos : TBGRAPointF;
  betweenDash: boolean;
...
var
  ...
  procedure AddPt(pt: TBGRAPointF);
  begin
  ...
  var dashLeftEndPos,dashRightEndPos: TBGRAPointF;
    i: Integer;
  begin
    if t=0 then
    begin
...
procedure BGRAPolyLine(bmp: TBGRACustomBitmap; const linepts: array of TBGRAPointF; width: single;
          pencolor: TBGRAPixel; linecap: TPenEndCap; joinstyle: TPenJoinStyle; const penstyle: TBGRAPenStyle;
...
var
  startArrowPos, startArrowDir, endArrowPos, endArrowDir: TBGRAPointF;
  ...
  compPts: array of TBGRAPointF;
  nbCompPts: integer;
  revCompPts: array of TBGRAPointF;
  nbRevCompPts: integer;
  pts: array of TBGRAPointF;
  roundPrecision: integer;
  hw: single; //half-width

  procedure AddPt(normal,rev: TBGRAPointF); overload;
  begin
  ...
  procedure AddRoundCap(origin: TBGRAPointF; dir: TBGRAPointF; fromCenter: boolean; flipped: boolean= false);
  var i: integer;
      a,s,c: single;
  ...
  procedure AddRoundCapAlphaJoin(origin: TBGRAPointF; dir: TBGRAPointF; fromCenter: boolean; flipped: boolean= false);
  var i: integer;
      a,s,c: single;
      offset,flipvalue: single;
  ...
  function ComputeRoundJoin(origin, pt1,pt2: TBGRAPointF): ArrayOfTPointF;
  var a1,a2: single;
      da: single;
      precision,i: integer;
  begin
...
var
  joinLeft,joinRight: array of TBGRAPointF;
  nbJoinLeft,nbJoinRight: integer;

  procedure SetJoinLeft(joinpts: array of TBGRAPointF);
  var i: integer;
  begin
  ...
  procedure SetJoinRight(joinpts: array of TBGRAPointF);
  var i: integer;
  begin
...
function ComputeWidePolyPolylinePoints(const linepts: array of TBGRAPointF;
...
var
  results: array of array of TBGRAPointF;
  nbResults,nbTotalPts: integer;

  procedure AddWidePolyline(startIndex,endIndexP1: integer);
  var
    tempWidePolyline: array of TBGRAPointF;
    subPts: array of TBGRAPointF;
    j : integer;
  begin
