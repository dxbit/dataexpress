...
type
  ...
  private
    ...
    function GetViewCenter: TBGRAPointF;
    function GetViewPoint: TPoint3D;
    function GetZoom: TBGRAPointF;
    ...
    procedure SetViewCenter(const AValue: TBGRAPointF);
    procedure SetViewPoint(const AValue: TPoint3D);
    procedure ComputeView(ScaleX,ScaleY: single);
    function ComputeCoordinate(ASceneCoord: TPoint3D_128; APart: IBGRAPart3D): TBGRAPointF; overload;
    function ComputeCoordinate(AViewCoord: TPoint3D_128): TBGRAPointF; overload;
  ...
  public
    ...
    procedure SetZoom(value: TBGRAPointF); overload;
    ...
    property ViewCenter: TBGRAPointF read GetViewCenter write SetViewCenter;
    ...
    property Zoom: TBGRAPointF read GetZoom write SetZoom;
...
type
  ...
  public
    ...
    function ComputeCoordinate(var ASceneCoord: TPoint3D_128; const AProjection: TProjection3D): TBGRAPointF;
  ...
  public
    ...
    function GetTexCoord(AIndex: Integer): TBGRAPointF;
    ...
    procedure SetTexCoord(AIndex: Integer; const AValue: TBGRAPointF);
    ...
    property TexCoord[AIndex: Integer]: TBGRAPointF read GetTexCoord write SetTexCoord;
  ...
  public
    ...
    function GetTexCoord: TBGRAPointF;
    ...
    procedure SetTexCoord(const AValue: TBGRAPointF);
    ...
    function GetProjectedCoord: TBGRAPointF;
    procedure SetProjectedCoord(const AValue: TBGRAPointF);
    ...
    property ProjectedCoord: TBGRAPointF read GetProjectedCoord write SetProjectedCoord;
    property TexCoord: TBGRAPointF read GetTexCoord write SetTexCoord;
...
function TBGRAVertex3D.GetTexCoord: TBGRAPointF;
begin
  result := FTexCoord;
end;
...
procedure TBGRAVertex3D.SetTexCoord(const AValue: TBGRAPointF);
begin
  FTexCoord := AValue;
end;
...
function TBGRAVertex3D.GetProjectedCoord: TBGRAPointF;
begin
  result := FCoordPool.CoordData[FCoordPoolIndex]^.projectedCoord;
end;

procedure TBGRAVertex3D.SetProjectedCoord(const AValue: TBGRAPointF);
begin
...
function TBGRAFace3D.GetTexCoord(AIndex: Integer): TBGRAPointF;
begin
  if (AIndex < 0) or (AIndex >= FVertexCount) then
    raise Exception.Create('Index out of bounds');
...
procedure TBGRAFace3D.SetTexCoord(AIndex: Integer; const AValue: TBGRAPointF);
begin
  if (AIndex < 0) or (AIndex >= FVertexCount) then
    raise Exception.Create('Index out of bounds');
...
function TBGRAPart3D.ComputeCoordinate(var ASceneCoord: TPoint3D_128; const AProjection: TProjection3D): TBGRAPointF;
...
function TBGRAScene3D.GetViewCenter: TBGRAPointF;
begin
...
function TBGRAScene3D.GetZoom: TBGRAPointF;
var size: single;
begin
  if FAutoZoom then
  begin
...
procedure TBGRAScene3D.SetViewCenter(const AValue: TBGRAPointF);
begin
  FViewCenter := AValue;
...
function TBGRAScene3D.ComputeCoordinate(ASceneCoord: TPoint3D_128; APart: IBGRAPart3D): TBGRAPointF;
begin
  result := APart.ComputeCoordinate(ASceneCoord, FProjection);
end;

function TBGRAScene3D.ComputeCoordinate(AViewCoord: TPoint3D_128): TBGRAPointF;
var InvZ: single;
begin
...
function IsPolyVisible(const p : array of TBGRAPointF; ori: integer = 1) : boolean;
var i: integer;
begin
  i := 0;
  while i<=high(p)-2 do
...
var
  ...
  LTexCoord: array of TBGRAPointF;
  LZ: array of single;
  LProj: array of TBGRAPointF;
...
procedure TBGRAScene3D.SetZoom(value: TBGRAPointF);
begin
  FZoom := value;
  FAutoZoom := false;
end;
