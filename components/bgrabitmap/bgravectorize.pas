...
type
  ...
  public
    ...
    destructor Destroy; override;
    function GetGlyphSize(AIdentifier:string): TBGRAPointF;
    function GetTextGlyphSizes(AText:string): TGlyphSizes;
    function GetTextSize(AText:string): TBGRAPointF;
    ...
    procedure DrawTextRect(ADest: TBGRACanvas2D; ATextUTF8: string; ATopLeft,ABottomRight: TBGRAPointF; AAlign: TBGRATypeWriterAlignment=twaTopLeft);
    ...
    function GetTextRectGlyphBoxes(ATextUTF8: string; ATopLeft,ABottomRight: TBGRAPointF; AAlign: TBGRATypeWriterAlignment=twaTopLeft): TGlyphBoxes;
...
uses LCLProc, FileUtil, lazutf8classes, LazUtf8;
...
function TBGRAVectorizedFont.GetGlyphSize(AIdentifier: string): TBGRAPointF;
var g: TBGRAGlyph;
begin
...
function TBGRAVectorizedFont.GetTextSize(AText: string): TBGRAPointF;
var
  pstr: pchar;
  left,charlen: integer;
  nextchar: string;
...
procedure TBGRAVectorizedFont.DrawTextRect(ADest: TBGRACanvas2D; ATextUTF8: string;
  ATopLeft, ABottomRight: TBGRAPointF; AAlign: TBGRATypeWriterAlignment);
begin
...
function TBGRAVectorizedFont.GetTextRectGlyphBoxes(ATextUTF8: string; ATopLeft,
  ABottomRight: TBGRAPointF; AAlign: TBGRATypeWriterAlignment): TGlyphBoxes;
begin
