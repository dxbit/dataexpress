...
type
  ...
  public
    constructor Create(const points: array of TBGRAPointF; const Colors: array of TBGRAPixel);
...
procedure PolygonLinearColorGradientAliased(bmp: TBGRACustomBitmap; const points: array of TBGRAPointF;
...
type
  ...
  protected
    ...
    procedure SetIntersectionValues(AInter: TIntersectionInfo; AInterX: Single; AWinding,
      ANumSegment: integer; dy: single; AData: pointer); override;
  public
    constructor Create(const points: array of TBGRAPointF; const pointsZ: array of single; const Colors: array of TBGRAPixel);
    function CreateSegmentData(numPt,nextPt: integer; x,y: single): pointer; override;
    function CreateIntersectionInfo: TIntersectionInfo; override;
  end;
...
procedure PolygonPerspectiveColorGradientAliased(bmp: TBGRACustomBitmap; const points: array of TBGRAPointF;
...
type
  ...
  TLinearTextureInfo = record
    TexCoord: TBGRAPointF;
    TexCoordSlopes: TBGRAPointF;
    lightness: single;
  ...
  protected
    FTexCoords: array of TBGRAPointF;
    FLightnesses: array of Word;
    procedure SetIntersectionValues(AInter: TIntersectionInfo; AInterX: Single; AWinding,
      ANumSegment: integer; dy: single; AData: pointer); override;
  public
    constructor Create(const points: array of TBGRAPointF; const texCoords: array of TBGRAPointF);
    constructor Create(const points: array of TBGRAPointF; const texCoords: array of TBGRAPointF; const lightnesses: array of word);
    function CreateSegmentData(numPt,nextPt: integer; x,y: single): pointer; override;
    function CreateIntersectionInfo: TIntersectionInfo; override;
  end;
...
procedure PolygonLinearTextureMappingAliased(bmp: TBGRACustomBitmap; const points: array of TBGRAPointF; texture: IBGRAScanner;
  const texCoords: array of TBGRAPointF; TextureInterpolation: Boolean; NonZeroWinding: boolean); overload;
procedure PolygonLinearTextureMappingAliasedWithLightness(bmp: TBGRACustomBitmap; const points: array of TBGRAPointF; texture: IBGRAScanner;
  const texCoords: array of TBGRAPointF; TextureInterpolation: Boolean; lightnesses: array of word; NonZeroWinding: boolean); overload;

type
  //segment information for perspective texture. Use inverse Z and slopes.
  TPerspectiveTextureInfo = record
    InvZ,InvZSlope: Single;
    TexCoordDivByZ: TBGRAPointF;
    TexCoordDivByZSlopes: TBGRAPointF;
    lightness: single;
    lightnessSlope: single;
  ...
  protected
    ...
    procedure SetIntersectionValues(AInter: TIntersectionInfo; AInterX: Single; AWinding,
      ANumSegment: integer; dy: single; AData: pointer); override;
  public
    constructor Create(const points: array of TBGRAPointF; const pointsZ: array of single; const texCoords: array of TBGRAPointF);
    constructor Create(const points: array of TBGRAPointF; const pointsZ: array of single; const texCoords: array of TBGRAPointF; const lightnesses: array of word);
    function CreateSegmentData(numPt,nextPt: integer; x,y: single): pointer; override;
    function CreateIntersectionInfo: TIntersectionInfo; override;
  end;
  ...
  protected
    ...
    procedure SetIntersectionValues(AInter: TIntersectionInfo; AInterX: Single; AWinding,
      ANumSegment: integer; dy: single; AData: pointer); override;
  public
    constructor Create(const points: array of TBGRAPointF; const points3D: array of TPoint3D; const normals: array of TPoint3D; const texCoords: array of TBGRAPointF);
    constructor Create(const points: array of TBGRAPointF; const points3D: array of TPoint3D_128; const normals: array of TPoint3D_128; const texCoords: array of TBGRAPointF);
    function CreateSegmentData(numPt,nextPt: integer; x,y: single): pointer; override;
    function CreateIntersectionInfo: TIntersectionInfo; override;
  end;
...
procedure PolygonPerspectiveTextureMappingAliased(bmp: TBGRACustomBitmap; const points: array of TBGRAPointF; const pointsZ: array of single; texture: IBGRAScanner;
           const texCoords: array of TBGRAPointF; TextureInterpolation: Boolean; NonZeroWinding: boolean; zbuffer: psingle = nil); overload;
procedure PolygonPerspectiveTextureMappingAliasedWithLightness(bmp: TBGRACustomBitmap; const points: array of TBGRAPointF; const pointsZ: array of single; texture: IBGRAScanner;
           const texCoords: array of TBGRAPointF; TextureInterpolation: Boolean; lightnesses: array of word; NonZeroWinding: boolean; zbuffer: psingle = nil); overload;
...
procedure PolygonPerspectiveMappingShaderAliased(bmp: TBGRACustomBitmap; const points: array of TBGRAPointF; const points3D: array of TPoint3D;
           const normals: array of TPoint3D; texture: IBGRAScanner; const texCoords: array of TBGRAPointF;
           TextureInterpolation: Boolean; ShaderFunction: TShaderFunction3D; NonZeroWinding: boolean;
           solidColor: TBGRAPixel; zbuffer: psingle = nil; ShaderContext: PBasicLightingContext= nil); overload;
procedure PolygonPerspectiveMappingShaderAliased(bmp: TBGRACustomBitmap; const points: array of TBGRAPointF; const points3D: array of TPoint3D_128;
           const normals: array of TPoint3D_128; texture: IBGRAScanner; const texCoords: array of TBGRAPointF;
           TextureInterpolation: Boolean; ShaderFunction: TShaderFunction3D; NonZeroWinding: boolean;
           solidColor: TBGRAPixel; zbuffer: psingle = nil; ShaderContext: PBasicLightingContext= nil); overload;
...
constructor TPolygonLinearColorGradientInfo.Create(
  const points: array of TBGRAPointF; const Colors: array of TBGRAPixel);
var
  i: Integer;
  lPoints: array of TBGRAPointF;
  nbP: integer;
...
constructor TPolygonLinearTextureMappingInfo.Create(const points: array of TBGRAPointF;
  const texCoords: array of TBGRAPointF);
var
  i: Integer;
  lPoints: array of TBGRAPointF;
  nbP: integer;
...
constructor TPolygonLinearTextureMappingInfo.Create(
  const points: array of TBGRAPointF; const texCoords: array of TBGRAPointF;
...
procedure PolygonLinearTextureMappingAliased(bmp: TBGRACustomBitmap;
  ...
  const texCoords: array of TBGRAPointF; TextureInterpolation: Boolean; NonZeroWinding: boolean);
...
procedure PolygonLinearTextureMappingAliasedWithLightness(
  bmp: TBGRACustomBitmap; const points: array of TBGRAPointF;
  texture: IBGRAScanner; const texCoords: array of TBGRAPointF;
