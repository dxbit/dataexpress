...
type
  ...
  public
    ...
    procedure SetPoints(const APoints: array of TBGRAPointF); overload;
    procedure SetPoints(const APoints: array of TBGRAPointF; const ACurveMode: array of TGlyphPointCurveMode); overload;
...
function ComputeEasyBezier(APoints: array of TBGRAPointF; AClosed: boolean; AMinimumDotProduct: single = 0.707): ArrayOfTPointF; overload;
function ComputeEasyBezier(APoints: array of TBGRAPointF; ACurveMode: array of TGlyphPointCurveMode; AClosed: boolean; AMinimumDotProduct: single = 0.707): ArrayOfTPointF; overload;

implementation

uses LCLProc, lazutf8classes, LazUtf8;

{$i winstream.inc}

function ComputeEasyBezier(APoints: array of TBGRAPointF; AClosed: boolean; AMinimumDotProduct: single = 0.707): ArrayOfTPointF;
var
...
function ComputeEasyBezier(APoints: array of TBGRAPointF;
...
procedure TBGRAPolygonalGlyph.SetPoints(const APoints: array of TBGRAPointF);
var i: integer;
begin
