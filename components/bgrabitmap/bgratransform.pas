...
type
  { Contains an affine matrix, i.e. a matrix to transform linearly and translate TBGRAPointF coordinates }
  ...
  private
    ...
    function GetBottomRight: TBGRAPointF;
    function GetIsEmpty: boolean;
  public
    TopLeft, TopRight,
    BottomLeft: TBGRAPointF;
    class function EmptyBox: TAffineBox;
    class function AffineBox(ATopLeft, ATopRight, ABottomLeft: TBGRAPointF): TAffineBox;
    property BottomRight: TBGRAPointF read GetBottomRight;
  ...
  public
    ...
    procedure Fit(Origin,HAxis,VAxis: TBGRAPointF); virtual;
  ...
  public
    ...
    procedure Fit(Origin, HAxis, VAxis: TBGRAPointF); override;
  end;
...
operator *(M: TAffineMatrix; V: TBGRAPointF): TBGRAPointF;
...
function AffineMatrixLinear(v1,v2: TBGRAPointF): TAffineMatrix;
...
type
  ...
  protected
    FScanner: IBGRAScanner;
    FMatrix: TAffineMatrix;
    FTexCoord1,FDiff2,FDiff3,FStep: TBGRAPointF;
    FCurTexCoord: TBGRAPointF;
    FScanAtFunc: TScanAtFunction;
  public
    constructor Create(AScanner: IBGRAScanner; pt1,pt2,pt3: TBGRAPointF; tex1,tex2,tex3: TBGRAPointF);
    procedure ScanMoveTo(X,Y: Integer); override;
...
type
  ...
  public
    constructor Create(texture: IBGRAScanner; texCoord1,texCoord2: TBGRAPointF; const quad: array of TBGRAPointF);
    constructor Create(texture: IBGRAScanner; const texCoordsQuad: array of TBGRAPointF; const quad: array of TBGRAPointF);
    destructor Destroy; override;
    procedure ScanMoveTo(X, Y: Integer); override;
    function ScanAt(X, Y: Single): TBGRAPixel; override;
    function ScanNextPixel: TBGRAPixel; override;
  ...
  private
    ...
    FOutsideValue: TBGRAPointF;
    FIncludeOppositePlane: boolean;
    procedure Init;
  public
    constructor Create; overload;
    constructor Create(x1,y1,x2,y2: single; const quad: array of TBGRAPointF);
    constructor Create(const quad: array of TBGRAPointF; x1,y1,x2,y2: single);
    constructor Create(const srcQuad,destQuad: array of TBGRAPointF);
    function MapQuadToQuad(const srcQuad,destQuad: array of TBGRAPointF): boolean;
    function MapRectToQuad(x1,y1,x2,y2: single; const quad: array of TBGRAPointF): boolean;
    function MapQuadToRect(const quad: array of TBGRAPointF; x1,y1,x2,y2: single): boolean;
    function MapSquareToQuad(const quad: array of TBGRAPointF): boolean;
    function MapQuadToSquare(const quad: array of TBGRAPointF): boolean;
    ...
    function Apply(pt: TBGRAPointF): TBGRAPointF;
    procedure ScanMoveTo(x,y:single);
    function ScanNext: TBGRAPointF;
    property OutsideValue: TBGRAPointF read FOutsideValue write FOutsideValue;
...
function TAffineBox.GetBottomRight: TBGRAPointF;
begin
  if IsEmpty then
    result := EmptyPointF
  else
...
class function TAffineBox.AffineBox(ATopLeft, ATopRight, ABottomLeft: TBGRAPointF): TAffineBox;
begin
...
constructor TBGRATriangleLinearMapping.Create(AScanner: IBGRAScanner; pt1, pt2,
  pt3: TBGRAPointF; tex1, tex2, tex3: TBGRAPointF);
begin
  FScanner := AScanner;
...
procedure TBGRAAffineScannerTransform.Fit(Origin, HAxis, VAxis: TBGRAPointF);
begin
...
procedure TBGRAAffineBitmapTransform.Fit(Origin, HAxis, VAxis: TBGRAPointF);
begin
...
constructor TBGRAPerspectiveScannerTransform.Create(texture: IBGRAScanner; texCoord1,texCoord2: TBGRAPointF; const quad: array of TBGRAPointF);
begin
...
constructor TBGRAPerspectiveScannerTransform.Create(texture: IBGRAScanner;
  const texCoordsQuad: array of TBGRAPointF; const quad: array of TBGRAPointF);
begin
...
constructor TPerspectiveTransform.Create(x1, y1, x2, y2: single;
  const quad: array of TBGRAPointF);
begin
  Init;
  MapRectToQuad(x1 ,y1 ,x2 ,y2 ,quad );
end;

constructor TPerspectiveTransform.Create(const quad: array of TBGRAPointF; x1, y1,
  x2, y2: single);
begin
  Init;
...
function TPerspectiveTransform.MapQuadToQuad(const srcQuad,
  destQuad: array of TBGRAPointF): boolean;
var
...
function TPerspectiveTransform.MapRectToQuad(x1, y1, x2, y2: single;
  const quad: array of TBGRAPointF): boolean;
begin
...
function TPerspectiveTransform.MapQuadToRect(const quad: array of TBGRAPointF; x1,
...
function TPerspectiveTransform.MapSquareToQuad(const quad: array of TBGRAPointF): boolean;
var
 d,d1,d2: TBGRAPointF;
 den ,u ,v : double;
...
function TPerspectiveTransform.MapQuadToSquare(const quad: array of TBGRAPointF): boolean;
begin
...
function TPerspectiveTransform.Apply(pt: TBGRAPointF): TBGRAPointF;
var
  m : single;
begin
...
function TPerspectiveTransform.ScanNext: TBGRAPointF;
var m: single;
begin
