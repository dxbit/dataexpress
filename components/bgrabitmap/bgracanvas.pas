...
type
  ...
  public
    ...
    procedure PolygonF(const APoints: array of TBGRAPointF);
    procedure PolygonF(const APoints: array of TBGRAPointF; Winding: Boolean; FillOnly: Boolean = False);
    procedure Polyline(const APoints: array of TPoint);
    procedure Polyline(const Points: array of TPoint;
                      StartIndex: Integer;
                      NumPts: Integer = -1);
    procedure Polyline(Points: PPoint; NumPts: Integer);
    procedure PolylineF(const APoints: array of TBGRAPointF);
...
var cx,cy,rx,ry,w: single;
    arcPts,penPts: array of TBGRAPointF;
...
procedure TBGRACanvas.PolygonF(const APoints: array of TBGRAPointF);
begin
  PolygonF(APoints, FillMode = fmWinding);
end;

procedure TBGRACanvas.PolygonF(const APoints: array of TBGRAPointF; Winding: Boolean; FillOnly: Boolean = False);
var
  multi: TBGRAMultishapeFiller;
  tex: IBGRAScanner;
begin
...
procedure TBGRACanvas.PolylineF(const APoints: array of TBGRAPointF);
