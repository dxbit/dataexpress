...
type
  PBGRAPointF = ^TBGRAPointF;
  TBGRAPointF = packed record
    x, y: single;
  end;
  ArrayOfTPointF = array of TBGRAPointF;
  TArcOption = (aoClosePath, aoPie, aoFillPath);
  TArcOptions = set of TArcOption;

  TCubicBezierCurve = record
    p1,c1,c2,p2: TBGRAPointF;
  end;
...
function BezierCurve(origin, control1, control2, destination: TBGRAPointF) : TCubicBezierCurve; overload;
function BezierCurve(origin, control, destination: TBGRAPointF) : TQuadraticBezierCurve; overload;
function BezierCurve(origin, destination: TBGRAPointF) : TQuadraticBezierCurve; overload;
...
const
  ...
  EmptyPointF: TBGRAPointF = (x: -3.402823e38; y: -3.402823e38); //used as a separator in TBGRAPointF lists
...
function isEmptyPointF(pt: TBGRAPointF): boolean;
...
type
  ...
  IBGRAPath = interface
    procedure closePath;
    procedure moveTo(const pt: TBGRAPointF);
    procedure lineTo(const pt: TBGRAPointF);
    procedure polylineTo(const pts: array of TBGRAPointF);
    procedure quadraticCurveTo(const cp,pt: TBGRAPointF);
    procedure bezierCurveTo(const cp1,cp2,pt: TBGRAPointF);
  ...
  protected
     ...
     function GetArrowEndSize: TBGRAPointF; virtual; abstract;
     function GetArrowStartSize: TBGRAPointF; virtual; abstract;
     procedure SetArrowEndSize(AValue: TBGRAPointF); virtual; abstract;
     procedure SetArrowStartSize(AValue: TBGRAPointF); virtual; abstract;
  ...
  public
     ...
     procedure DrawPolyLineAntialias(const points: array of TBGRAPointF; c: TBGRAPixel; w: single); virtual; abstract; overload;
     procedure DrawPolyLineAntialias(const points: array of TBGRAPointF; texture: IBGRAScanner; w: single); virtual; abstract; overload;
     procedure DrawPolyLineAntialias(const points: array of TBGRAPointF; c: TBGRAPixel; w: single; Closed: boolean); virtual; abstract; overload;
     procedure DrawPolygonAntialias(const points: array of TBGRAPointF; c: TBGRAPixel; w: single); virtual; abstract; overload;
     procedure DrawPolygonAntialias(const points: array of TBGRAPointF; texture: IBGRAScanner; w: single); virtual; abstract; overload;
     ...
     procedure ErasePolyLineAntialias(const points: array of TBGRAPointF; alpha: byte; w: single); virtual; abstract; overload;
     ...
     procedure FillTriangleLinearColor(pt1,pt2,pt3: TBGRAPointF; c1,c2,c3: TBGRAPixel); virtual; abstract; overload;
     procedure FillTriangleLinearColorAntialias(pt1,pt2,pt3: TBGRAPointF; c1,c2,c3: TBGRAPixel); virtual; abstract; overload;
     procedure FillTriangleLinearMapping(pt1,pt2,pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF; TextureInterpolation: Boolean= True); virtual; abstract; overload;
     procedure FillTriangleLinearMappingLightness(pt1,pt2,pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF; light1,light2,light3: word; TextureInterpolation: Boolean= True); virtual; abstract; overload;
     procedure FillTriangleLinearMappingAntialias(pt1,pt2,pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF); virtual; abstract; overload;

     procedure FillQuadLinearColor(pt1,pt2,pt3,pt4: TBGRAPointF; c1,c2,c3,c4: TBGRAPixel); virtual; abstract; overload;
     procedure FillQuadLinearColorAntialias(pt1,pt2,pt3,pt4: TBGRAPointF; c1,c2,c3,c4: TBGRAPixel); virtual; abstract; overload;
     procedure FillQuadLinearMapping(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; TextureInterpolation: Boolean= True);  virtual; abstract; overload;
     procedure FillQuadLinearMappingLightness(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; light1,light2,light3,light4: word; TextureInterpolation: Boolean= True); virtual; abstract; overload;
     procedure FillQuadLinearMappingAntialias(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF); virtual; abstract; overload;
     procedure FillQuadPerspectiveMapping(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF); virtual; abstract; overload;
     procedure FillQuadPerspectiveMapping(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; ACleanBorders: TRect); virtual; abstract; overload;
     procedure FillQuadPerspectiveMappingAntialias(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF); virtual; abstract; overload;
     procedure FillQuadPerspectiveMappingAntialias(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; ACleanBorders: TRect); virtual; abstract; overload;

     procedure FillPolyLinearColor(const points: array of TBGRAPointF; AColors: array of TBGRAPixel);  virtual; abstract; overload;
     procedure FillPolyLinearMapping(const points: array of TBGRAPointF; texture: IBGRAScanner; texCoords: array of TBGRAPointF; TextureInterpolation: Boolean); virtual; abstract; overload;
     procedure FillPolyLinearMappingLightness(const points: array of TBGRAPointF; texture: IBGRAScanner; texCoords: array of TBGRAPointF; lightnesses: array of word; TextureInterpolation: Boolean); virtual; abstract; overload;
     procedure FillPolyPerspectiveMapping(const points: array of TBGRAPointF; const pointsZ: array of single; texture: IBGRAScanner; texCoords: array of TBGRAPointF; TextureInterpolation: Boolean; zbuffer: psingle = nil); virtual; abstract; overload;
     procedure FillPolyPerspectiveMappingLightness(const points: array of TBGRAPointF; const pointsZ: array of single; texture: IBGRAScanner; texCoords: array of TBGRAPointF; lightnesses: array of word; TextureInterpolation: Boolean; zbuffer: psingle = nil); virtual; abstract; overload;

     procedure FillPoly(const points: array of TBGRAPointF; c: TBGRAPixel; drawmode: TDrawMode); virtual; abstract;
     procedure FillPoly(const points: array of TBGRAPointF; texture: IBGRAScanner; drawmode: TDrawMode); virtual; abstract;
     procedure FillPolyAntialias(const points: array of TBGRAPointF; c: TBGRAPixel); virtual; abstract;
     procedure FillPolyAntialias(const points: array of TBGRAPointF; texture: IBGRAScanner); virtual; abstract;
     procedure ErasePoly(const points: array of TBGRAPointF; alpha: byte); virtual; abstract;
     procedure ErasePolyAntialias(const points: array of TBGRAPointF; alpha: byte); virtual; abstract;
     ...
     {Spline}
     function ComputeClosedSpline(const APoints: array of TBGRAPointF; AStyle: TSplineStyle): ArrayOfTPointF; virtual; abstract;
     function ComputeOpenedSpline(const APoints: array of TBGRAPointF; AStyle: TSplineStyle): ArrayOfTPointF; virtual; abstract;
     ...
     function ComputeWidePolyline(const points: array of TBGRAPointF; w: single): ArrayOfTPointF; virtual; abstract;
     function ComputeWidePolyline(const points: array of TBGRAPointF; w: single; Closed: boolean): ArrayOfTPointF; virtual; abstract;
     function ComputeWidePolygon(const points: array of TBGRAPointF; w: single): ArrayOfTPointF; virtual; abstract;
     ...
     procedure GradientFill(x, y, x2, y2: integer; c1, c2: TBGRAPixel;
       gtype: TGradientType; o1, o2: TBGRAPointF; mode: TDrawMode;
     ...
     procedure PutImageAffine(Origin,HAxis,VAxis: TBGRAPointF; Source: TBGRACustomBitmap; AOpacity: Byte=255; ACorrectBlur: Boolean = false); overload;
     procedure PutImageAffine(Origin,HAxis,VAxis: TBGRAPointF; Source: TBGRACustomBitmap; AResampleFilter: TResampleFilter; AOpacity: Byte=255); overload;
     procedure PutImageAffine(Origin,HAxis,VAxis: TBGRAPointF; Source: TBGRACustomBitmap; AOutputBounds: TRect; AResampleFilter: TResampleFilter; AMode: TDrawMode; AOpacity: Byte=255); virtual; abstract; overload;
     procedure PutImageAffine(Origin,HAxis,VAxis: TBGRAPointF; Source: TBGRACustomBitmap; AOutputBounds: TRect; AOpacity: Byte=255; ACorrectBlur: Boolean = false); overload;
     function GetImageAffineBounds(Origin,HAxis,VAxis: TBGRAPointF; Source: TBGRACustomBitmap): TRect;
     ...
     procedure ComputeImageAngleAxes(x,y,w,h,angle: single; imageCenterX,imageCenterY: single; ARestoreOffsetAfterRotation: boolean;
       out Origin,HAxis,VAxis: TBGRAPointF);
     ...
     function FilterRotate(origin: TBGRAPointF; angle: single; correctBlur: boolean = false): TBGRACustomBitmap; virtual; abstract;
     ...
     property ArrowStartSize: TBGRAPointF read GetArrowStartSize write SetArrowStartSize;
     property ArrowEndSize: TBGRAPointF read GetArrowEndSize write SetArrowEndSize;
...
{ Point functions }
function PointF(x, y: single): TBGRAPointF;
function PointsF(const pts: array of TBGRAPointF): ArrayOfTPointF;
operator = (const pt1, pt2: TBGRAPointF): boolean; inline;
operator - (const pt1, pt2: TBGRAPointF): TBGRAPointF; inline;
operator - (const pt2: TBGRAPointF): TBGRAPointF; inline;
operator + (const pt1, pt2: TBGRAPointF): TBGRAPointF; inline;
operator * (const pt1, pt2: TBGRAPointF): single; inline; //scalar product
operator * (const pt1: TBGRAPointF; factor: single): TBGRAPointF; inline;
operator * (factor: single; const pt1: TBGRAPointF): TBGRAPointF; inline;
...
function VectLen(v: TBGRAPointF): single; overload;

{ Line and polygon functions }
type
    TLineDef = record
       origin, dir: TBGRAPointF;
    end;

function IntersectLine(line1, line2: TLineDef): TBGRAPointF;
function IntersectLine(line1, line2: TLineDef; out parallel: boolean): TBGRAPointF;
function IsConvex(const pts: array of TBGRAPointF; IgnoreAlign: boolean = true): boolean;
function DoesQuadIntersect(pt1,pt2,pt3,pt4: TBGRAPointF): boolean;
function DoesSegmentIntersect(pt1,pt2,pt3,pt4: TBGRAPointF): boolean;
...
function BezierCurve(origin, control1, control2, destination: TBGRAPointF): TCubicBezierCurve;
begin
  result.p1 := origin;
  result.c1 := control1;
  result.c2 := control2;
...
function BezierCurve(origin, control, destination: TBGRAPointF
...
//straight line
function BezierCurve(origin, destination: TBGRAPointF): TQuadraticBezierCurve;
begin
  result.p1 := origin;
...
procedure TBGRACustomBitmap.PutImageAffine(Origin, HAxis, VAxis: TBGRAPointF;
...
function TBGRACustomBitmap.GetImageAffineBounds(Origin, HAxis, VAxis: TBGRAPointF;
  Source: TBGRACustomBitmap): TRect;
var minx,miny,maxx,maxy: integer;
    vx,vy,pt1: TBGRAPointF;
    sourceBounds: TRect;

  //include specified point in the bounds
  procedure Include(pt: TBGRAPointF);
  begin
...
var
  Origin,HAxis,VAxis: TBGRAPointF;
begin
  if (source = nil) or (AOpacity=0) then exit;
...
procedure TBGRACustomBitmap.ComputeImageAngleAxes(x, y, w, h,
  ...
  ARestoreOffsetAfterRotation: boolean; out Origin, HAxis, VAxis: TBGRAPointF);
var
  cosa,sina: single;

  { Compute rotated coordinates }
  function Coord(relX,relY: single): TBGRAPointF;
  begin
    relX -= imageCenterX;
    relY -= imageCenterY;
...
operator =(const pt1, pt2: TBGRAPointF): boolean;
begin
  result := (pt1.x = pt2.x) and (pt1.y = pt2.y);
end;

operator-(const pt1, pt2: TBGRAPointF): TBGRAPointF;
begin
  result.x := pt1.x-pt2.x;
  result.y := pt1.y-pt2.y;
end;

operator-(const pt2: TBGRAPointF): TBGRAPointF;
begin
  result.x := -pt2.x;
  result.y := -pt2.y;
end;
...
operator*(const pt1, pt2: TBGRAPointF): single;
begin
  result := pt1.x*pt2.x + pt1.y*pt2.y;
end;

operator*(const pt1: TBGRAPointF; factor: single): TBGRAPointF;
begin
  result.x := pt1.x*factor;
  result.y := pt1.y*factor;
end;

operator*(factor: single; const pt1: TBGRAPointF): TBGRAPointF;
begin
  result.x := pt1.x*factor;
  result.y := pt1.y*factor;
end;
...
function VectLen(v: TBGRAPointF): single;
begin
