...
type
  ...
  public
    ...
    function ConvertCoord(pt: TBGRAPointF; sourceUnit, destUnit: TCSSUnit): TBGRAPointF; virtual;
...
function TCSSUnitConverter.ConvertCoord(pt: TBGRAPointF; sourceUnit,
  destUnit: TCSSUnit): TBGRAPointF;
begin
