...
type
  ...
  private
    function GetCustomDpi: TBGRAPointF;
    procedure Recompute;
  protected
    FSvg: TDOMElement;
    ...
    function GetCustomOrigin: TBGRAPointF;
    procedure SetCustomOrigin(AValue: TBGRAPointF);
    procedure SetViewBox(AValue: TSVGViewBox);
    procedure SetCustomDpi(ADpi: TBGRAPointF);
  ...
  public
    ...
    property CustomOrigin: TBGRAPointF read GetCustomOrigin write SetCustomOrigin;
    property CustomDpiX: single read GetCustomDpiX;
    property CustomDpiY: single read GetCustomDpiY;
    property CustomDpi: TBGRAPointF read GetCustomDpi write SetCustomDpi;
  end;
  ...
  private
    ...
    procedure SetCustomDpi(AValue: TBGRAPointF);
  ...
  protected
    ...
    procedure InternalDraw(ACanvas2d: TBGRACanvas2D; x,y: single; AUnit: TCSSUnit; destDpi: TBGRAPointF); overload;
  ...
  public
    ...
    procedure Draw(ACanvas2d: TBGRACanvas2D; x,y: single; destDpi: TBGRAPointF); overload;
...
function TSVGUnits.GetCustomOrigin: TBGRAPointF;
begin
  result := FViewBox.min;
end;

procedure TSVGUnits.SetCustomOrigin(AValue: TBGRAPointF);
...
function TSVGUnits.GetCustomDpi: TBGRAPointF;
begin
...
procedure TSVGUnits.SetCustomDpi(ADpi: TBGRAPointF);
var vb: TSVGViewBox;
  vs: TSVGSize;
begin
  vb := ViewBox;
...
function TBGRASVG.GetCustomDpi: TBGRAPointF;
begin
...
procedure TBGRASVG.SetCustomDpi(AValue: TBGRAPointF);
begin
...
procedure TBGRASVG.Draw(ACanvas2d: TBGRACanvas2D; x, y: single; destDpi: TBGRAPointF);
begin
...
procedure TBGRASVG.InternalDraw(ACanvas2d: TBGRACanvas2D; x, y: single;
  AUnit: TCSSUnit; destDpi: TBGRAPointF);
var prevMatrix: TAffineMatrix;
begin
