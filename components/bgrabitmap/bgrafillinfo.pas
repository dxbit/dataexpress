...
type
  ...
  private
    ...
    function GetCenter: TBGRAPointF;
  protected
  ...
  public
    ...
    function GetBounds: TRect; override;
    function SegmentsCurved: boolean; override;
    property Center: TBGRAPointF read GetCenter;
  ...
  private
    ...
    function GetTopLeft: TBGRAPointF;
  protected
    function NbMaxIntersection: integer; override;
    procedure ComputeIntersection(cury: single;
      var inter: ArrayOfTIntersectionInfo; var nbInter: integer); override;
  public
    ...
    function SegmentsCurved: boolean; override;
    function GetBounds: TRect; override;
    property TopLeft: TBGRAPointF read GetTopLeft;
  ...
  public
    constructor Create(const points: array of TBGRAPointF);
...
function IsPointInPolygon(const points: ArrayOfTPointF; point: TBGRAPointF; windingMode: boolean): boolean;
function IsPointInEllipse(x,y,rx,ry: single; point: TBGRAPointF): boolean;
function IsPointInRoundRectangle(x1, y1, x2, y2, rx, ry: single; point: TBGRAPointF): boolean;
function IsPointInRectangle(x1, y1, x2, y2: single; point: TBGRAPointF): boolean;
...
function IsPointInPolygon(const points: ArrayOfTPointF; point: TBGRAPointF
...
function IsPointInRoundRectangle(x1, y1, x2, y2, rx, ry: single; point: TBGRAPointF
  ): boolean;
var info: TBGRACustomFillInfo;
begin
...
constructor TCustomFillPolyInfo.Create(const points: array of TBGRAPointF);
var
  i, j: integer;
...
constructor TFillPolyInfo.Create(const points: array of TBGRAPointF);
...
constructor TOnePassFillPolyInfo.Create(const points: array of TBGRAPointF);
var i,j: integer;
  p: POnePassRecord;
  temp: single;
begin
...
constructor TSimpleFillPolyInfo.Create(const points: array of TBGRAPointF);
var i,j: integer;
begin
  inherited Create(points);
...
function TFillEllipseInfo.GetCenter: TBGRAPointF;
begin
...
function TFillRoundRectangleInfo.GetBottomRight: TBGRAPointF;
begin
  result := PointF(FX2-0.5,FY2-0.5);
end;

function TFillRoundRectangleInfo.GetTopLeft: TBGRAPointF;
begin
