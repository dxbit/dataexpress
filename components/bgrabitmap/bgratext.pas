...
function BGRATextUnderline(ATopLeft: TBGRAPointF; AWidth: Single; AMetrics: TFontPixelMetric): ArrayOfTPointF; overload;
function BGRATextUnderline(ATopLeft: TBGRAPointF; AWidth: Single; ABaseline, AEmHeight: single): ArrayOfTPointF; overload;
function BGRATextStrikeOut(ATopLeft: TBGRAPointF; AWidth: Single; AMetrics: TFontPixelMetric): ArrayOfTPointF; overload;
function BGRATextStrikeOut(ATopLeft: TBGRAPointF; AWidth: Single; ABaseline, AEmHeight, AXHeight: single): ArrayOfTPointF; overload;
...
uses GraphType, Math, BGRABlend, LCLProc, LazUtf8;
...
function BGRATextUnderline(ATopLeft: TBGRAPointF;
...
function BGRATextStrikeOut(ATopLeft: TBGRAPointF; AWidth: Single;
...
function BGRATextStrikeOut(ATopLeft: TBGRAPointF; AWidth: Single; ABaseline,
...
var
  ...
  size: TSize;
  temp: TBGRACustomBitmap;
  TopRight,BottomRight,BottomLeft: TBGRAPointF;
  Top: Single;
  Left: Single;
  cosA,sinA: single;
  rotBounds: TRect;
  ...
  procedure rotBoundsAdd(pt: TBGRAPointF);
  begin
