...
type
  ...
  public
    ...
    procedure AddPolygon(const points: array of TBGRAPointF; AColor: TBGRAPixel);
    procedure AddPolygon(const points: array of TBGRAPointF; ATexture: IBGRAScanner);
    procedure AddTriangleLinearColor(pt1, pt2, pt3: TBGRAPointF; c1, c2, c3: TBGRAPixel);
    procedure AddTriangleLinearMapping(pt1, pt2, pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF);
    procedure AddQuadLinearColor(pt1, pt2, pt3, pt4: TBGRAPointF; c1, c2, c3, c4: TBGRAPixel);
    procedure AddQuadLinearMapping(pt1, pt2, pt3, pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF);
    procedure AddQuadPerspectiveMapping(pt1, pt2, pt3, pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF);
...
procedure FillPolyAliased(bmp: TBGRACustomBitmap; points: array of TBGRAPointF;
  c: TBGRAPixel; EraseMode: boolean; NonZeroWinding: boolean; drawmode: TDrawMode);
procedure FillPolyAliasedWithTexture(bmp: TBGRACustomBitmap; points: array of TBGRAPointF;
  scan: IBGRAScanner; NonZeroWinding: boolean; drawmode: TDrawMode);
procedure FillPolyAntialias(bmp: TBGRACustomBitmap; points: array of TBGRAPointF;
  c: TBGRAPixel; EraseMode: boolean; NonZeroWinding: boolean; LinearBlend: boolean = false);
procedure FillPolyAntialiasWithTexture(bmp: TBGRACustomBitmap; points: array of TBGRAPointF;
  scan: IBGRAScanner; NonZeroWinding: boolean; LinearBlend: boolean = false);
...
procedure FillPolyAliasedWithTexture(bmp: TBGRACustomBitmap;
  points: array of TBGRAPointF; scan: IBGRAScanner; NonZeroWinding: boolean; drawmode: TDrawMode);
var
  info: TCustomFillPolyInfo;
begin
  if length(points) < 3 then
...
procedure FillPolyAntialiasWithTexture(bmp: TBGRACustomBitmap;
  points: array of TBGRAPointF; scan: IBGRAScanner; NonZeroWinding: boolean; LinearBlend: boolean);
var
  info: TCustomFillPolyInfo;
begin
  if length(points) < 3 then
...
procedure TBGRAMultishapeFiller.AddPolygon(const points: array of TBGRAPointF;
  AColor: TBGRAPixel);
begin
...
procedure TBGRAMultishapeFiller.AddTriangleLinearColor(pt1, pt2, pt3: TBGRAPointF; c1, c2,
  c3: TBGRAPixel);
var
...
procedure TBGRAMultishapeFiller.AddQuadLinearColor(pt1, pt2, pt3, pt4: TBGRAPointF;
