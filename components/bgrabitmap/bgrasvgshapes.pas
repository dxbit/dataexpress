...
type
  ...
  TSVGContent = class
    ...
    public
      ...
      function AppendLine(p1,p2: TBGRAPointF; AUnit: TCSSUnit = cuCustom): TSVGLine; overload;
      function AppendCircle(cx,cy,r: single; AUnit: TCSSUnit = cuCustom): TSVGCircle; overload;
      function AppendCircle(c: TBGRAPointF; r: single; AUnit: TCSSUnit = cuCustom): TSVGCircle; overload;
      function AppendEllipse(cx,cy,rx,ry: single; AUnit: TCSSUnit = cuCustom): TSVGEllipse; overload;
      function AppendEllipse(c,r: TBGRAPointF; AUnit: TCSSUnit = cuCustom): TSVGEllipse; overload;
      ...
      function AppendPolygon(const points: array of TBGRAPointF; AUnit: TCSSUnit = cuCustom): TSVGPolypoints; overload;
      function AppendRect(x,y,width,height: single; AUnit: TCSSUnit = cuCustom): TSVGRectangle; overload;
      function AppendRect(origin,size: TBGRAPointF; AUnit: TCSSUnit = cuCustom): TSVGRectangle; overload;
      function AppendText(x,y: single; AText: string; AUnit: TCSSUnit = cuCustom): TSVGText; overload;
      function AppendText(origin: TBGRAPointF; AText: string; AUnit: TCSSUnit = cuCustom): TSVGText; overload;
      function AppendRoundRect(x,y,width,height,rx,ry: single; AUnit: TCSSUnit = cuCustom): TSVGRectangle; overload;
      function AppendRoundRect(origin,size,radius: TBGRAPointF; AUnit: TCSSUnit = cuCustom): TSVGRectangle; overload;
...
function TSVGContent.AppendLine(p1, p2: TBGRAPointF; AUnit: TCSSUnit): TSVGLine;
begin
...
function TSVGContent.AppendCircle(c: TBGRAPointF; r: single; AUnit: TCSSUnit
  ): TSVGCircle;
begin
...
function TSVGContent.AppendEllipse(c, r: TBGRAPointF; AUnit: TCSSUnit): TSVGEllipse;
begin
...
function TSVGContent.AppendPolygon(const points: array of TBGRAPointF;
  AUnit: TCSSUnit): TSVGPolypoints;
var
  pts: ArrayOfTPointF;
  i: integer;
...
function TSVGContent.AppendRect(origin, size: TBGRAPointF; AUnit: TCSSUnit
  ): TSVGRectangle;
begin
...
function TSVGContent.AppendText(origin: TBGRAPointF; AText: string; AUnit: TCSSUnit
  ): TSVGText;
begin
...
function TSVGContent.AppendRoundRect(origin, size, radius: TBGRAPointF;
  AUnit: TCSSUnit): TSVGRectangle;
begin
