...
type
  ...
  private
    ...
    FEndSizeFactor: TBGRAPointF;
    FEndTipStyle: TPenJoinStyle;
    FEndOffsetX: single;
    FEndRepeatCount: integer;
    FEndRelativePenWidth: single;
    FEndTriangleBackOffset: single;
    function ComputeAnyAt(const AData: ArrayOfTPointF; const APosition, ADirection: TBGRAPointF): ArrayOfTPointF;
    function ComputeData(AStyle: TBGRAArrowStyle; const ASizeFactor: TBGRAPointF;
    ...
    procedure SetEndSizeFactor(AValue: TBGRAPointF);
    ...
    procedure SetStartSizeFactor(AValue: TBGRAPointF);
  ...
  public
    ...
    procedure SetEnd(AStyle: TBGRAArrowStyle; ATipStyle: TPenJoinStyle;
        ARelativePenWidth: single; ATriangleBackOffset: single);
    function ComputeStartAt(const APosition: TBGRAPointF; const ADirection: TBGRAPointF; const AWidth: single; const ACurrentPos: single): ArrayOfTPointF;
    function ComputeEndAt(const APosition: TBGRAPointF; const ADirection: TBGRAPointF; const AWidth: single; const ACurrentPos: single): ArrayOfTPointF;
    ...
    property StartSize: TBGRAPointF read FStartSizeFactor write SetStartSizeFactor;
    property EndSize: TBGRAPointF read FEndSizeFactor write SetEndSizeFactor;
...
function TBGRAArrow.ComputeAnyAt(const AData: ArrayOfTPointF; const APosition,
  ADirection: TBGRAPointF): ArrayOfTPointF;
var m: TAffineMatrix;
  i: integer;
begin
...
function TBGRAArrow.ComputeData(AStyle: TBGRAArrowStyle;
  const ASizeFactor: TBGRAPointF; ATipStyle: TPenJoinStyle; ALineCap: TPenEndCap;
...
procedure TBGRAArrow.SetEndSizeFactor(AValue: TBGRAPointF);
begin
...
procedure TBGRAArrow.SetStartSizeFactor(AValue: TBGRAPointF);
begin
...
function TBGRAArrow.ComputeStartAt(const APosition: TBGRAPointF;
  const ADirection: TBGRAPointF; const AWidth: single; const ACurrentPos: single
  ): ArrayOfTPointF;
begin
...
function TBGRAArrow.ComputeEndAt(const APosition: TBGRAPointF;
  const ADirection: TBGRAPointF; const AWidth: single; const ACurrentPos: single
  ): ArrayOfTPointF;
begin
