...
type
  ...
  protected
    ...
    function GetArrowEndSize: TBGRAPointF; override;
    function GetArrowStartSize: TBGRAPointF; override;
    procedure SetArrowEndSize(AValue: TBGRAPointF); override;
    procedure SetArrowStartSize(AValue: TBGRAPointF); override;
  ...
  public
    ...
    procedure DrawPolyLineAntialias(const points: array of TBGRAPointF; c: TBGRAPixel; w: single); override;
    procedure DrawPolyLineAntialias(const points: array of TBGRAPointF; texture: IBGRAScanner; w: single); override;
    procedure DrawPolyLineAntialias(const points: array of TBGRAPointF; c: TBGRAPixel; w: single; Closed: boolean); override;
    procedure DrawPolygonAntialias(const points: array of TBGRAPointF; c: TBGRAPixel; w: single); override;
    procedure DrawPolygonAntialias(const points: array of TBGRAPointF; texture: IBGRAScanner; w: single); override;
    ...
    procedure ErasePolyLineAntialias(const points: array of TBGRAPointF; alpha: byte; w: single); override;

    procedure FillPath(APath: IBGRAPath; c: TBGRAPixel); override;
    procedure FillPath(APath: IBGRAPath; texture: IBGRAScanner); override;

    procedure FillTriangleLinearColor(pt1,pt2,pt3: TBGRAPointF; c1,c2,c3: TBGRAPixel); override;
    procedure FillTriangleLinearColorAntialias(pt1,pt2,pt3: TBGRAPointF; c1,c2,c3: TBGRAPixel); override;
    procedure FillTriangleLinearMapping(pt1,pt2,pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF; TextureInterpolation: Boolean= True); override;
    procedure FillTriangleLinearMappingLightness(pt1,pt2,pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF; light1,light2,light3: word; TextureInterpolation: Boolean= True); override;
    procedure FillTriangleLinearMappingAntialias(pt1,pt2,pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF); override;

    procedure FillQuadLinearColor(pt1,pt2,pt3,pt4: TBGRAPointF; c1,c2,c3,c4: TBGRAPixel); override;
    procedure FillQuadLinearColorAntialias(pt1,pt2,pt3,pt4: TBGRAPointF; c1,c2,c3,c4: TBGRAPixel); override;
    procedure FillQuadLinearMapping(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; TextureInterpolation: Boolean= True); override;
    procedure FillQuadLinearMappingLightness(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; light1,light2,light3,light4: word; TextureInterpolation: Boolean= True); override;
    procedure FillQuadLinearMappingAntialias(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF); override;
    procedure FillQuadPerspectiveMapping(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF); override;
    procedure FillQuadPerspectiveMapping(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; ACleanBorders: TRect); override;
    procedure FillQuadPerspectiveMappingAntialias(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF); override;
    procedure FillQuadPerspectiveMappingAntialias(pt1,pt2,pt3,pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; ACleanBorders: TRect); override;

    procedure FillPolyLinearMapping(const points: array of TBGRAPointF; texture: IBGRAScanner; texCoords: array of TBGRAPointF; TextureInterpolation: Boolean); override;
    procedure FillPolyLinearMappingLightness(const points: array of TBGRAPointF; texture: IBGRAScanner; texCoords: array of TBGRAPointF; lightnesses: array of word; TextureInterpolation: Boolean); override;
    procedure FillPolyLinearColor(const points: array of TBGRAPointF; AColors: array of TBGRAPixel); override;
    procedure FillPolyPerspectiveMapping(const points: array of TBGRAPointF; const pointsZ: array of single; texture: IBGRAScanner; texCoords: array of TBGRAPointF; TextureInterpolation: Boolean; zbuffer: psingle = nil); override;
    procedure FillPolyPerspectiveMappingLightness(const points: array of TBGRAPointF; const pointsZ: array of single; texture: IBGRAScanner; texCoords: array of TBGRAPointF; lightnesses: array of word; TextureInterpolation: Boolean; zbuffer: psingle = nil); override;

    procedure FillPoly(const points: array of TBGRAPointF; c: TBGRAPixel; drawmode: TDrawMode); override;
    procedure FillPoly(const points: array of TBGRAPointF; texture: IBGRAScanner; drawmode: TDrawMode); override;
    procedure FillPolyAntialias(const points: array of TBGRAPointF; c: TBGRAPixel); override;
    procedure FillPolyAntialias(const points: array of TBGRAPointF; texture: IBGRAScanner); override;
    procedure ErasePoly(const points: array of TBGRAPointF; alpha: byte); override;
    procedure ErasePolyAntialias(const points: array of TBGRAPointF; alpha: byte); override;
    ...
    {Spline}
    function ComputeClosedSpline(const APoints: array of TBGRAPointF; AStyle: TSplineStyle): ArrayOfTPointF; override;
    function ComputeOpenedSpline(const APoints: array of TBGRAPointF; AStyle: TSplineStyle): ArrayOfTPointF; override;
    ...
    function ComputeWidePolyline(const points: array of TBGRAPointF; w: single): ArrayOfTPointF; override;
    function ComputeWidePolyline(const points: array of TBGRAPointF; w: single; Closed: boolean): ArrayOfTPointF; override;
    function ComputeWidePolygon(const points: array of TBGRAPointF; w: single): ArrayOfTPointF; override;
    ...
    procedure PutImageAffine(Origin,HAxis,VAxis: TBGRAPointF; Source: TBGRACustomBitmap; AOutputBounds: TRect; AResampleFilter: TResampleFilter; AMode: TDrawMode; AOpacity: Byte=255); override;
    ...
    function FilterRotate(origin: TBGRAPointF; angle: single; correctBlur: boolean = false): TBGRACustomBitmap; override;
...
procedure BGRAGradientFill(bmp: TBGRACustomBitmap; x, y, x2, y2: integer;
  c1, c2: TBGRAPixel; gtype: TGradientType; o1, o2: TBGRAPointF; mode: TDrawMode;
...
function TBGRADefaultBitmap.GetArrowEndSize: TBGRAPointF;
begin
  result := GetArrow.EndSize;
end;

function TBGRADefaultBitmap.GetArrowStartSize: TBGRAPointF;
begin
  result := GetArrow.StartSize;
end;

procedure TBGRADefaultBitmap.SetArrowEndSize(AValue: TBGRAPointF);
begin
  GetArrow.EndSize := AValue;
end;

procedure TBGRADefaultBitmap.SetArrowStartSize(AValue: TBGRAPointF);
begin
...
procedure TBGRADefaultBitmap.DrawPolyLineAntialias(const points: array of TBGRAPointF;
  c: TBGRAPixel; w: single);
begin
  if Assigned(FArrow) then
...
procedure TBGRADefaultBitmap.DrawPolyLineAntialias(
  const points: array of TBGRAPointF; texture: IBGRAScanner; w: single);
begin
  if Assigned(FArrow) then
...
procedure TBGRADefaultBitmap.DrawPolygonAntialias(const points: array of TBGRAPointF;
  c: TBGRAPixel; w: single);
begin
...
procedure TBGRADefaultBitmap.ErasePolyLineAntialias(const points: array of TBGRAPointF;
  alpha: byte; w: single);
begin
  FEraseMode := True;
...
procedure TBGRADefaultBitmap.FillTriangleLinearColor(pt1, pt2, pt3: TBGRAPointF;
  c1, c2, c3: TBGRAPixel);
begin
...
procedure TBGRADefaultBitmap.FillTriangleLinearColorAntialias(pt1, pt2,
  pt3: TBGRAPointF; c1, c2, c3: TBGRAPixel);
var
...
procedure TBGRADefaultBitmap.FillTriangleLinearMapping(pt1, pt2, pt3: TBGRAPointF;
  texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF; TextureInterpolation: Boolean= True);
begin
...
procedure TBGRADefaultBitmap.FillTriangleLinearMappingLightness(pt1, pt2,
  pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF; light1,
...
procedure TBGRADefaultBitmap.FillTriangleLinearMappingAntialias(pt1, pt2,
  pt3: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3: TBGRAPointF);
var
...
procedure TBGRADefaultBitmap.FillQuadLinearColor(pt1, pt2, pt3, pt4: TBGRAPointF;
...
procedure TBGRADefaultBitmap.FillQuadLinearColorAntialias(pt1, pt2, pt3,
  pt4: TBGRAPointF; c1, c2, c3, c4: TBGRAPixel);
...
procedure TBGRADefaultBitmap.FillQuadLinearMapping(pt1, pt2, pt3, pt4: TBGRAPointF;
  texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; TextureInterpolation: Boolean= True);
var
  center: TBGRAPointF;
  centerTex: TBGRAPointF;
begin
  center := (pt1+pt2+pt3+pt4)*(1/4);
...
procedure TBGRADefaultBitmap.FillQuadLinearMappingLightness(pt1, pt2, pt3,
  pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF; light1,
...
procedure TBGRADefaultBitmap.FillQuadLinearMappingAntialias(pt1, pt2, pt3,
  pt4: TBGRAPointF; texture: IBGRAScanner; tex1, tex2, tex3, tex4: TBGRAPointF);
var multi : TBGRAMultishapeFiller;
begin
  multi := TBGRAMultishapeFiller.Create;
...
procedure TBGRADefaultBitmap.FillPolyLinearMapping(const points: array of TBGRAPointF;
  texture: IBGRAScanner; texCoords: array of TBGRAPointF;
...
procedure TBGRADefaultBitmap.FillPolyLinearMappingLightness(
  const points: array of TBGRAPointF; texture: IBGRAScanner;
  texCoords: array of TBGRAPointF; lightnesses: array of word;
  TextureInterpolation: Boolean);
begin
...
procedure TBGRADefaultBitmap.FillPolyLinearColor(
  const points: array of TBGRAPointF; AColors: array of TBGRAPixel);
begin
...
procedure TBGRADefaultBitmap.FillPolyPerspectiveMapping(
  const points: array of TBGRAPointF; const pointsZ: array of single;
  texture: IBGRAScanner; texCoords: array of TBGRAPointF;
...
procedure TBGRADefaultBitmap.FillPoly(const points: array of TBGRAPointF;
...
procedure TBGRADefaultBitmap.FillPolyAntialias(const points: array of TBGRAPointF; c: TBGRAPixel);
begin
  BGRAPolygon.FillPolyAntialias(self, points, c, FEraseMode, FillMode = fmWinding, LinearAntialiasing);
end;

procedure TBGRADefaultBitmap.FillPolyAntialias(const points: array of TBGRAPointF;
  texture: IBGRAScanner);
begin
  BGRAPolygon.FillPolyAntialiasWithTexture(self, points, texture, FillMode = fmWinding, LinearAntialiasing);
end;

procedure TBGRADefaultBitmap.ErasePoly(const points: array of TBGRAPointF;
  alpha: byte);
begin
  BGRAPolygon.FillPolyAliased(self, points, BGRA(0, 0, 0, alpha), True, FillMode = fmWinding, dmDrawWithTransparency);
end;

procedure TBGRADefaultBitmap.ErasePolyAntialias(const points: array of TBGRAPointF; alpha: byte);
begin
  FEraseMode := True;
...
function TBGRADefaultBitmap.ComputeClosedSpline(const APoints: array of TBGRAPointF; AStyle: TSplineStyle): ArrayOfTPointF;
begin
  result := BGRAPath.ComputeClosedSpline(APoints, AStyle);
end;

function TBGRADefaultBitmap.ComputeOpenedSpline(const APoints: array of TBGRAPointF; AStyle: TSplineStyle): ArrayOfTPointF;
begin
...
function TBGRADefaultBitmap.ComputeWidePolyline(const points: array of TBGRAPointF;
...
function TBGRADefaultBitmap.ComputeWidePolygon(const points: array of TBGRAPointF;
  w: single): ArrayOfTPointF;
begin
...
procedure TBGRADefaultBitmap.GradientFill(x, y, x2, y2: integer;
  gradient: TBGRACustomGradient; gtype: TGradientType; o1, o2: TBGRAPointF;
...
procedure TBGRADefaultBitmap.PutImageAffine(Origin, HAxis, VAxis: TBGRAPointF;
...
function TBGRADefaultBitmap.FilterRotate(origin: TBGRAPointF;
