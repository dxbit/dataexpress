...
type
  ...
  protected
    ...
    procedure Init(gtype: TGradientType; o1, o2: TBGRAPointF; Sinus: Boolean=False);
    procedure InitScanInline(x,y: integer);
    function ScanNextInline: TBGRAPixel; inline;
  public
    constructor Create(c1, c2: TBGRAPixel; gtype: TGradientType; o1, o2: TBGRAPointF;
                       gammaColorCorrection: boolean = True; Sinus: Boolean=False);
    constructor Create(gradient: TBGRACustomGradient; gtype: TGradientType; o1, o2: TBGRAPointF; Sinus: Boolean=False; AGradientOwner: Boolean=False);
  ...
  protected
    ...
    FCurColor: TColorF;
  public
    constructor Create(pt1,pt2,pt3: TBGRAPointF; c1,c2,c3: TBGRAPixel);
    procedure ScanMoveTo(X,Y: Integer); override;
...
constructor TBGRAGradientTriangleScanner.Create(pt1, pt2, pt3: TBGRAPointF; c1, c2,
  c3: TBGRAPixel);
...
procedure TBGRAGradientScanner.Init(gtype: TGradientType; o1, o2: TBGRAPointF;
  Sinus: Boolean);
begin
  FGradientType:= gtype;
  FOrigin1 := o1;
...
constructor TBGRAGradientScanner.Create(c1, c2: TBGRAPixel;
  gtype: TGradientType; o1, o2: TBGRAPointF; gammaColorCorrection: boolean;
  Sinus: Boolean);
begin
...
constructor TBGRAGradientScanner.Create(gradient: TBGRACustomGradient;
  gtype: TGradientType; o1, o2: TBGRAPointF; Sinus: Boolean; AGradientOwner: Boolean=False);
begin
  FGradient := gradient;
