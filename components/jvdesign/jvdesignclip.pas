...
begin
  {DD := False;
  Wr := CreateLRSWriter(InStream, DD);
  try
    Wr.Root := InComponent.Owner;
    Wr.WriteComponent(InComponent);
  finally
    if DD then
      Wr.Driver.Free;
    Wr.Free;
...
Hide details
Change log
r943 by cheatengine on Jul 4, 2011   Diff
renamed Cheat engine 6 to Cheat engine
Go to: 	
Double click a line to add a comment
Older revisions
 r941 by cheatengine on Jul 4, 2011   Diff 
 r708 by dark_byte on Feb 7, 2011   Diff 
 r674 by dark_byte on Jan 12, 2011   Diff 
All revisions of this file
File info
Size: 5396 bytes, 227 lines
View raw file
